function varargout = collagen_flow_3D_GUI(varargin)
% COLLAGEN_FLOW_3D_GUI M-file for collagen_flow_3D_GUI.fig
%      COLLAGEN_FLOW_3D_GUI, by itself, creates a new COLLAGEN_FLOW_3D_GUI or raises the existing
%      singleton*.
%
%      H = COLLAGEN_FLOW_3D_GUI returns the handle to a new COLLAGEN_FLOW_3D_GUI or the handle to
%      the existing singleton*.
%
%      COLLAGEN_FLOW_3D_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in COLLAGEN_FLOW_3D_GUI.M with the given input arguments.
%
%      COLLAGEN_FLOW_3D_GUI('Property','Value',...) creates a new COLLAGEN_FLOW_3D_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before collagen_flow_3D_GUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to collagen_flow_3D_GUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help collagen_flow_3D_GUI

% Last Modified by GUIDE v2.5 27-Mar-2013 09:46:48

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @collagen_flow_3D_GUI_OpeningFcn, ...
                   'gui_OutputFcn',  @collagen_flow_3D_GUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before collagen_flow_3D_GUI is made visible.
function collagen_flow_3D_GUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to collagen_flow_3D_GUI (see VARARGIN)

% Choose default command line output for collagen_flow_3D_GUI
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes collagen_flow_3D_GUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = collagen_flow_3D_GUI_OutputFcn(hObject, eventdata, handles) 

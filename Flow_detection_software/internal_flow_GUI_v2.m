function varargout = internal_flow_GUI_v2(varargin)
% INTERNAL_FLOW_GUI_V2 M-file for internal_flow_GUI_v2.fig
%      INTERNAL_FLOW_GUI_V2, by itself, creates a new INTERNAL_FLOW_GUI_V2 or raises the existing
%      singleton*.
%
%      H = INTERNAL_FLOW_GUI_V2 returns the handle to a new INTERNAL_FLOW_GUI_V2 or the handle to
%      the existing singleton*.
%
%      INTERNAL_FLOW_GUI_V2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in INTERNAL_FLOW_GUI_V2.M with the given input arguments.
%
%      INTERNAL_FLOW_GUI_V2('Property','Value',...) creates a new INTERNAL_FLOW_GUI_V2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before internal_flow_GUI_v2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to internal_flow_GUI_v2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help internal_flow_GUI_v2

% Last Modified by GUIDE v2.5 17-May-2012 00:05:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @internal_flow_GUI_v2_OpeningFcn, ...
                   'gui_OutputFcn',  @internal_flow_GUI_v2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before internal_flow_GUI_v2 is made visible.
function internal_flow_GUI_v2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to internal_flow_GUI_v2 (see VARARGIN)

% Choose default command line output for internal_flow_GUI_v2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes internal_flow_GUI_v2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = internal_flow_GUI_v2_OutputFcn(hObject, eventdata, handles) 
...
if get(handles.skip_edge,'Value')==1
    im=handles.im;
    handles.BW2=0*im+1;
    handles.im_e=im;
else
...
% --- Executes on button press in skip_edge.
function skip_edge_Callback(hObject, eventdata, handles)
% hObject    handle to skip_edge (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of skip_edge
